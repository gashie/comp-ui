...
const CommonSettings = () => {
  ...
  const [borderStroke, setBorderStrok] = useState("svgstroke-b");
  const [theme, setTheme] = useState("SunOrange");
  ...
  element?.setAttribute("data-bs-theme", "dark");
  const elementside = document.getElementById("sidebar");
  elementside?.setAttribute("data-bs-theme", "dark");
  const breadcrumb = document.getElementById("breadcrumb");
  breadcrumb?.setAttribute("data-bs-theme", "dark");
  const headerbarDark = document.getElementById("headerbarDark");
  headerbarDark?.setAttribute("data-bs-theme", "dark");
