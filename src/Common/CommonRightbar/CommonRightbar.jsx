...
const CommonRightbar = () => {
  ...
  return (
    <aside
      ...
      data-bs-theme="none"
    >
      <div className="navbar navbar-expand-xxl px-3 px-xl-0 py-0" style={{backgroundColor: "white"}} >
        <div
                    ...
                    <div className="card border-0">
                      ...
                      <div className="card-body d-flex align-items-start">
                        ...
                        <div className="flex-fill ms-3">
                          <h6 className="mb-4">
                            Best of trendy design in <a href="#">2022</a> on
                            Awards
                          </h6>
                          <a href="#" title="Go to Awards">
                            Go to Awards
                  ...
                  <li className="col-12 d-flex align-items-start">
                    ...
                    <div className="text-truncate ms-2 ps-3 border-start dashed border-0">
                      <span className="d-flex align-items-center mb-3">
                        <img
                          className="avatar sm rounded-circle border border-3 me-2"
                          src={avatar5}
                          alt="avatar"
                        />
                        Michelle Glover
