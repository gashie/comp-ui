...
//MANAGE
import ManageCategories from "../pages/Manage/category/category";

import ManageStock from "../pages/Manage/stock/stock";
import ManageSuppliers from "../pages/Manage/supplier/supplier";
import ManageProducts from "../pages/Manage/product/product";
import AddProduct from "../pages/Manage/product/add-product";
import EditProduct from "../pages/Manage/product/edit-product";
import ManageProductOption from "../pages/Manage/product-option/product-option";
import ManageProductOptionValue from "../pages/Manage/product-option-value/product-option-value";

//HOME
import Home from '../pages/Home/index'
import Welcome from '../pages/Authentication/Welcome'
import ManageShops from "../pages/Manage/shops";
import ManageBrands from "../pages/Manage/brands";
import ManageUnits from "../pages/Manage/unit";
import ManageUsers from '../pages/Manage/users/'
import ManageCustomers from "../pages/Manage/customers";
import InventoryHistory from "../pages/Manage/stock/inventoryHistory";
import TransferStock from "../pages/Manage/stock/transferStock";
import CreateConsignment from "../pages/Manage/stock/createConsigment";
import POS from '../pages/Manage/pos'
//dashboards
import GeneralDashboard from '../pages/Dashboards/GeneralDashboard/'
import EcommerceDashboard from '../pages/Dashboards/EcommerceDashboard/index'
import ProductDashboard from '../pages/Dashboards/ProductDashboard'
import CreditDashboard from '../pages/Dashboards/CreditDashboard'
import ReportDashboard from '../pages/Dashboards/ReportDashboard/'
import CreditHistory from "../pages/Manage/pos/creditHistory";

import ProfitPerOutlet from '../pages/Manage/Reports/ProfitPerOutlet'
import ReorderByOutlet from '../pages/Manage/Reports/ReorderByOutlet'
import Reorder from '../pages/Manage/Reports/Reorder'
import OverheadExpenses from '../pages/Manage/Reports/OverheadExpenses'
import ProfitMargins from '../pages/Manage/Reports/ProfitMargins'
import EmployeePerformance from '../pages/Manage/Reports/EmployeePerformance'
import SalesProfitCharges from '../pages/Manage/Reports/SalesProfitCharges'
import SalesByCategory from '../pages/Manage/Reports/SalesByCategory'

import Expense from "../pages/Manage/Expenses";
import Income from "../pages/Manage/Income";
import Payroll from '../pages/Manage/Payroll'
import PublishPayroll from "../pages/Manage/Payroll/Publish";
import Receipt from "../pages/Manage/Payroll/reciept";
import PayrollItems from '../pages/Manage/Payroll/PayrollItems'

import Reports from "../pages/Manage/Reports";
import IncomeCategory from "../pages/Manage/Income/IncomeCategory";
import ExpenseCategory from "../pages/Manage/Expenses/ExpenseCategory";
import SalesHistory from '../pages/Manage/pos/SaleHistory'
import Profile from '../pages/Authentication/Profile'
import OutletInventory from "../pages/Dashboards/OutletReportDashboard";
import SwitchOutlets from '../pages/Manage/shops/SwitchOutlets'


import Locations from '../pages/Locations'
import Carriers from "../pages/Carriers";
import CarrierRates from "../pages/Carriers/carrierRates";
import ParentLocations from "../pages/Locations/ParentLocation";
...
const authProtectedRoutes = [
 ...
 { path: "/edit-product/:prodId", component: <EditProduct /> },
 { path: "/product-option/:prodId", component: <ManageProductOption /> },
 { path: "/option-value/:prodId/:opId", component: <ManageProductOptionValue /> },
 { path: "/manage-stock", component: <ManageStock /> },
 { path: "/manage-brands", component: <ManageBrands /> },
 { path: "/manage-shops", component: <ManageShops /> },
 ...
 { path: "/warehouse-dashboard", component: <ProductDashboard /> },
 { path: "/credit-dashboard", component: <CreditDashboard /> },
 { path: "/report-dashboard", component: <ReportDashboard /> },
 { path: "/ecommerce-dashboard", component: <EcommerceDashboard /> },
 { path: "/transfer-stock", component: <TransferStock /> },
 { path: "/create-consignment", component: <CreateConsignment /> },
...
//  { path: "/report-dashboard", component: <ReportDashboard /> },
 ...
 { path: "/publish-payroll", component: <PublishPayroll /> },
 { path: "/generate-receipt", component: <Receipt /> },
 { path: "/payroll-items", component: <PayrollItems /> },

 //reports
 { path: "/salesbycategory", component: <SalesByCategory /> },
 { path: "/salesandprofitcharges", component: <SalesProfitCharges /> },
 { path: "/employeeperformance", component: <EmployeePerformance /> },
 { path: "/profitmargins", component: <ProfitMargins /> },
 { path: "/overheadexpenses", component: <OverheadExpenses /> },
 { path: "/reorder", component: <Reorder /> },
 { path: "/reorderbyoutlet", component: <ReorderByOutlet /> },
 { path: "/profitperoutlet", component: <ProfitPerOutlet /> },
 { path: "/profile", component: <Profile /> },
 { path: "/outletinventoryreport", component: <OutletInventory /> },

 { path: "/switchoutlets", component: <SwitchOutlets /> },



 { path: "/locations", component: <Locations /> },
{ path: "/carriers", component: <Carriers /> },
{ path: "/carrierrates", component: <CarrierRates /> },
//parent locations
{ path: "/parentlocations", component: <ParentLocations /> },
